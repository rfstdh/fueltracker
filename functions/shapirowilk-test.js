...
export const checkNormality = (shapiroValue, sampleLength) => {
    //console.log("testing value", shapiroValue)
    //console.log("length", sampleLength)
    if(shapiroValue < 0.748) return false;
    if(shapiroValue > 0.947) return true;
    else {
        // p-values for n >= 3 to n <= 50
        let pValues = [0.767,0.748,0.762,0.788,0.803,0.818,0.829,0.842,
                        0.85,0.859,0.866,0.874,0.881,0.887,0.892,0.897,0.901,0.905,
                        0.908,0.911,0.914,0.916,0.918,0.920,0.923,0.924,0.926,0.927,
                        0.929,0.93,0.931,0.933,0.934,0.935,0.936,0.938,0.939,0.94,
                        0.941,0.942,0.943,0.944,0.945,0.945,0.946,0.947,0.947,0.947];
        //console.log("correspoding p value", pValues[sampleLength - 3])
        return pValues[sampleLength - 3] <= shapiroValue;
    }
}